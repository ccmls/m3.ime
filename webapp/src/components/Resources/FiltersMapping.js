...
export const filtersMapping = {
    ...
    angulos: "Ângulos",
    posicoesDeRetas: "Posição de retas",
    ...
    funcoesDo1GrauFuncoesLinearesFuncoesAfim: "Funções do 1.º grau / Funções lineares / Funções afim",
    funcoesDo2GrauFuncoesQuadraticas: "Funções do 2.º grau / Funções quadráticas",
    ...
    equacoesEInequacoes: "Equação, inequação",

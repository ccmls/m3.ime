...
Uma aula dupla
    ...
    <synopsis>
<![CDATA[
O experimento é dividido em duas etapas, nas quais os alunos trabalharão em duplas para resolver um problema de otimização através do estudo de uma função quadrática. Na primeira etapa, eles tentarão achar a maior área possível para um cercado retangular. Na segunda, com base na solução anterior, tentarão resolver uma variação do problema.
]]>
    </synopsis>
    <objectives>
<![CDATA[
Resolver um problema de otimização através do estudo de uma função quadrática.
Estudar as propriedades de uma função quadrática.
]]>
    </objectives>
    <requirements></requirements>
    <file1_id></file1_id>
...
Conhecer uma aplicação prática para os conceitos de função, equação e inequação aﬁns.
]]>
    </objectives>
    <requirements>
<![CDATA[
...
Determinantes e Áreas
    ...
    <synopsis>
<![CDATA[
Este software permite aos alunos interpretarem geometricamente o conceito de determinantes de matrizes 2×2, aproximando-se da deﬁnição de determinantes de matrizes como forma de medir volumes de paralelepípedos.
]]>
    </synopsis>
    <objectives>
<![CDATA[
Veriﬁcar a relação entre áreas e determinantes;
...
Determinantes e Polígonos
    ...
    <synopsis>
<![CDATA[
Neste software, apresentamos um método simples e eﬁcaz para calcular a área de polígonos utilizando determinantes de matrizes 2×2.
]]>
    </synopsis>
    <objectives>
<![CDATA[
...
Medidas do Corpo: Gráfico de Dispersão
    ...
    <synopsis>
<![CDATA[
Neste software, o aluno irá estudar análise exploratória de dados para duas variáveis: número do calçado e altura. A relação entre essas duas variáveis quantitativas será analisada através do chamado gráﬁco de dispersão e do coeﬁciente de correlação linear.
]]>
    </synopsis>
    <objectives>
<![CDATA[
Analisar representação gráﬁca de dados estatísticos
...
Como comprar sua moto
    ...
    <synopsis>
<![CDATA[
Neste software, o estudante simulará a compra de uma moto. Para isso, primeiramente será preciso guardar dinheiro na poupança e, depois, esse valor será dado como entrada na compra da moto. O restante do preço será ﬁnanciado. Para facilitar os cálculos dessa aquisição, serão necessários alguns conceitos de Progressão Geométrica.
]]>
    </synopsis>
    <objectives>
<![CDATA[
...
Mostrar aplicações de progressão geométrica em matemática ﬁnanceira.
]]>
    </objectives>
    <requirements>
<![CDATA[
...
Medidas do Corpo: Box plot
    ...
    <synopsis>
<![CDATA[
Neste software, o aluno irá estudar um exemplo de estatística descritiva utilizando medidas de três variáveis: gênero, altura e número do calçado. Vamos explorar a análise da relação entre duas variáveis, uma qualitativa e outra quantitativa, através do chamado gráﬁco de Box Plot.
]]>
    </synopsis>
    <objectives>
<![CDATA[
...
Otimização do cone
    ...
    <synopsis>
<![CDATA[
Neste software, os alunos explorarão um problema de otimização de volume de cones primeiramente através da análise de casos especíﬁcos e, depois, através da determinação da função que fornece os volumes dos cones e a análise de seu gráﬁco.
]]>
    </synopsis>
    <objectives>
<![CDATA[
...
aula dupla
    ...
    <synopsis>
<![CDATA[
Trabalhando em grupo, os alunos deverão construir figuras em papel quadriculado a partir de sequências de comandos. Caberá ao professor relacionar as figuras com as construções vetoriais, cujas propriedades e definição podem ser explicadas matematicamente.
]]>
    </synopsis>
    <objectives>
<![CDATA[
Obter padrões geométricos em uma malha quadriculada a partir de regras algébricas;
Familiarizar o aluno com o conceito de vetores no plano.
]]>
    </objectives>
    <requirements>
